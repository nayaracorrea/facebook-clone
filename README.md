...
Este é um clone da página inicial do Facebook utilizando Tailwind CSS.
...
<p align="center" style="display: flex; align-items: flex-start; justify-content: center;">
  <img alt="NextLevelWeek" title="#NextLevelWeek" src="/public/img/page.png" width="400px">
</p>
...
# A aplicação estará pronta para ser executada - Instale a extensão Live Server no VSCode
